(() => {
  ...
  function pe(e) {
    ...
    function o(e) {
        ...
        r && (a += "next" === l ? n : -1 * n),
          s.visibleSlidesIndexes &&
            ...
            (s.params.centeredSlides
              ? (a =
                  a > o ? a - Math.floor(i / 2) + 1 : a + Math.floor(i / 2) - 1)
      ...
      if (
        ...
        for (let e = 0; e < a; e += 1) s.slides.eq(t.realIndex + e).addClass(l);
    }
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if ((ue(), document.querySelector(".thumbs-images"))) {
        const e = new ae(".thumbs-images", {
          modules: [oe, ce, pe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 6,
  ...
  new fe("max").init();
  const me = document.querySelector(".top-header"),
    ge = me.querySelector(".top-header-mobile__contact"),
    ve = me.querySelector(".header-arrow");
  ge.addEventListener("click", () => {
    me.classList.toggle("top-mobile__active"),
      me.classList.contains("top-mobile__active")
        ? (ve.style.transform = "rotate(180deg)")
        : (ve.style.transform = "rotate(0deg)");
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
